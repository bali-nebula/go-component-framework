...
func CheckoutClause(recipient abs.RecipientLike, level abs.ExpressionLike, moniker abs.ExpressionLike) abs.CheckoutClauseLike {
...
func (v *checkoutClause) SetRecipient(recipient abs.RecipientLike) {
	if recipient == nil {
