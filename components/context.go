...
func Context(parameters abs.CatalogLike[abs.Symbolic, any]) abs.ContextLike {
	var v = &context{}
...
// context.
type context struct {
	parameters abs.CatalogLike[abs.Symbolic, any]
}
...
// component context.
func (v *context) GetValue(name abs.Symbolic) any {
...
func (v *context) GetParameters() abs.CatalogLike[abs.Symbolic, any] {
	return v.parameters
}
