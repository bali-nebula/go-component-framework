...
func TestSpectrWithBinaries(t *tes.T) {
	...
	ass.False(t, s.IncludesValue(str.BinaryFromArray([]byte{0x0, 0x0, 0x0})))
	ass.True(t, s.IncludesValue(first))
	ass.True(t, s.IncludesValue(str.BinaryFromArray([]byte{0x0, 0x2, 0x3})))
	ass.True(t, s.IncludesValue(last))
	ass.False(t, s.IncludesValue(str.BinaryFromArray([]byte{0xa, 0xb, 0xd})))
...
func TestSpectrWithMonikers(t *tes.T) {
	...
	ass.False(t, s.IncludesValue("/bali"))
	ass.False(t, s.IncludesValue(first))
	ass.True(t, s.IncludesValue("/bali/abstractions/Sequential"))
	ass.True(t, s.IncludesValue(last))
	ass.False(t, s.IncludesValue("/bali/strings/Version"))
	ass.Equal(t, first, s.GetFirst())
...
func TestSpectrWithQuotes(t *tes.T) {
	...
	ass.False(t, s.IncludesValue("1"))
	ass.False(t, s.IncludesValue(first))
	ass.True(t, s.IncludesValue("Boo"))
	ass.False(t, s.IncludesValue(last))
	ass.False(t, s.IncludesValue("Google"))
	ass.Equal(t, first, s.GetFirst())
...
func TestSpectrWithVersions(t *tes.T) {
	...
	ass.False(t, s.IncludesValue("v1"))
	ass.True(t, s.IncludesValue(first))
	ass.True(t, s.IncludesValue("v1.5.3"))
	ass.False(t, s.IncludesValue(last))
	ass.False(t, s.IncludesValue("v1.6.2"))
	ass.Equal(t, first, s.GetFirst())
