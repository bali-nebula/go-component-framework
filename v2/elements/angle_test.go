...
func TestNegativeAngles(t *tes.T) {
	...
	v = Angle.FromFloat(-mat.Pi / 2.0)
	ass.Equal(t, 1.5*mat.Pi, v.AsFloat())
}

func TestAnglesLibrary(t *tes.T) {
	var v0 = Angle.Zero()
	var v1 = Angle.FromFloat(mat.Pi * 0.25)
	var v2 = Angle.FromFloat(mat.Pi * 0.5)
	var v3 = Angle.FromFloat(mat.Pi * 0.75)
	var v4 = Angle.Pi()
	var v5 = Angle.FromFloat(mat.Pi * 1.25)
	var v6 = Angle.FromFloat(mat.Pi * 1.5)
	var v7 = Angle.FromFloat(mat.Pi * 1.75)
	var v8 = Angle.Tau()
