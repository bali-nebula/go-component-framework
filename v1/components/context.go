...
func Parameter(name abs.SymbolLike, value abs.ComponentLike) abs.ParameterLike {
...
func Context() abs.ContextLike {
	var parameters = col.Catalog[abs.SymbolLike, abs.ComponentLike]()
...
func (v *context) GetValue(name abs.SymbolLike) abs.ComponentLike {
	return v.parameters.GetValue(name)
}

// This method set the value of the parameter associated with the specified
// name.
func (v *context) SetValue(name abs.SymbolLike, value abs.ComponentLike) {
