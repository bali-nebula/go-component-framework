...
func BinaryFromBytes(bytes []byte) abs.BinaryLike {
...
// This constructor creates a new binary string from the specified byte array.
// It returns the corresponding binary string.
func BinaryFromArray(array []abs.Byte) abs.BinaryLike {
...
func BinaryFromSequence(sequence abs.Sequential[abs.Byte]) abs.BinaryLike {
...
func (v Binary) AsArray() []abs.Byte {
	var bytes = v.AsBytes()
...
func (v Binary) GetValue(index int) abs.Byte {
	var array = v.AsArray()
	var bytes = col.Array[abs.Byte](array)
	return bytes.GetValue(index)
}

// This method retrieves from this string all bytes from the first index
// through the last index (inclusive).
func (v Binary) GetValues(first int, last int) abs.Sequential[abs.Byte] {
	var array = v.AsArray()
	var bytes = col.Array[abs.Byte](array)
...
func (l binaries) Concatenate(first, second abs.BinaryLike) abs.BinaryLike {
	...
	var allBytes = make([]abs.Byte, len(firstBytes)+len(secondBytes))
